(function (global, factory) {
  ...
  var lang = {
    ...
    de: {
      ...
      number: "Tn dieses Feld dürfen nur Zahlen eingegeben werden",
      integer: "In dieses Feld dürfen nur ganze Zahlen eingegeben werden",
      url: "Bitte geben Sie eine gültige URL ein",
      tel: "Bitte geben Sie eine Telefonnummer ein",
      maxlength: "Maximale Eingabelänge: ${1} Zeichen",
      minlength: "Minimale Eingabelänge > ${1} Zeichen",
      min: "Minimaler Wert: ${1}",
      max: "Maximaler Wert: ${1}",
      pattern: "Bitte geben Sie einen dem Format entsprechenden Wert ein",
      equals: "Die beiden Felder sind nicht identisch"
    }
  };
